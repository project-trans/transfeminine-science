...
trackHash: 8cef21470a1b8a98d1453f93275cd22699eaa041
aliases: /about
weight: 4
---
...
Sam （代词：她/Ta）是一名跨性别女性，成长于英国伦敦，后北迁至约克郡河谷国家公园。自 2018 年开始激素转变过程起，她对正式的医学文献一直保持密切跟踪。Sam 目前受雇于机器学习等数据驱动行业，为业务决策提供高级咨询服务。她的专业技能有生物统计学和计算建模，便于预测性分析。

Sam 已为 *Transfeminine Science* 贡献了数篇文章。她的爱好还有徒步旅行、天体物理和观星/星空摄影等等。
...
Mitzi （代词：她/Ta）是一名非二元性别（女性倾向）人士，现居于英国伦敦。她在自行安排 HRT 用药（DIY）的社群中尤其活跃，在其中她作为指导者，向社群倡导在自行用药当中[控制药物损害][wiki-harmredu]。\
...
Luna（代词：她）是一名女性和非二元跨性别者，计算机科学家，现居于英国伦敦。
...
跨性别女性，计算机系出身。自 2021 年十一月开始转变以来，她密切关注跨性别医学动向，尤其是 *Transfeminine Science* 内容；至 2022 年十月止，在原 Limelight 社区总计发布 9 篇 *Transfeminine Science* 文章的翻译稿；随后加入 Project Trans 团体，正式开始诸译文的系统性整理工作。尽管她很少参与社群讨论，但如果有需要，她会力所能及地提供用药指导——以及一些其他方面的独到见解。目前她是 MtF.wiki 药物板块的常驻编者之一。
